...
const server = http.createServer(async (req,res)=>{
  try {
    ...
    if(u.pathname === '/api/health') return send(res,200,{ok:true,service:'DealMantra API',time:new Date().toISOString()});
...
server.listen(PORT,()=>console.log(`DealMantra is running at http://localhost:${PORT}`));
